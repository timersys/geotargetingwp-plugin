	...
	<form name="geot-settings" method="post" enctype="multipart/form-data">
		<table class="form-table">
			...
			<tr valign="top" class="">
				...
				<td colspan="3">
					<label><input type="checkbox" id="geo-flags" name="geot_settings[addons][geo-flags]" value="1" <?php checked($opts['addons']['geo-flags'],'1');?>/>
			...
			<tr valign="top" class="">
				...
				<td colspan="3">
					<label><input type="checkbox" id="geo-links" name="geot_settings[addons][geo-links]" value="1" <?php checked($opts['addons']['geo-links'],'1');?>/>
			...
			<tr valign="top" class="">
				...
				<td colspan="3">
					<label><input type="checkbox" id="geo-redirects" name="geot_settings[addons][geo-redirects]" value="1" <?php checked($opts['addons']['geo-redirects'],'1');?>/>
			...
			<tr valign="top" class="">
				...
				<td colspan="3">
					<label><input type="checkbox" id="geo-blocker" name="geot_settings[addons][geo-blocker]" value="1" <?php checked($opts['addons']['geo-blocker'],'1');?>/>
