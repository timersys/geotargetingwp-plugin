	...
	<form name="geot-settings" method="post" enctype="multipart/form-data">
		<table class="form-table">
			...
			<tr valign="top" class="">
				...
				<td colspan="3">
					<input type="checkbox" id="ajax_mode" name="geot_settings[ajax_mode]" value="1" <?php checked($opts['ajax_mode'],'1');?>/>
			...
			<tr valign="top" class="">
				...
				<td colspan="3">
					<input type="checkbox" id="menu_integration" name="geot_settings[disable_menu_integration]" value="1" <?php checked($opts['disable_menu_integration'],'1');?>/>
			...
			<tr valign="top" class="">
				...
				<td colspan="3">
					<input type="checkbox" id="widget_integration" name="geot_settings[disable_widget_integration]" value="1" <?php checked($opts['disable_widget_integration'],'1');?>/>
			...
			<tr><td><input type="submit" name="geot_settings[button]" class="button-primary" value="<?php _e( 'Save settings', 'geot' );?>"/></td>
