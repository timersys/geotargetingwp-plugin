	...
	<div id="geot_editor" class="shortcode_editor" title="Country Geo Target Text" style="">
		...
		<table class="form-table">
			<tr>
				...
				<td>
					<input type="radio" class="geot_include_mode" name="geot_include_mode" value="include"> <strong>Only
						show content in</strong><br/>
					<input type="radio" class="geot_include_mode" name="geot_include_mode" value="exclude"> <strong>Never
						show content in</strong><br/><br/>
				</td>
			</tr>
			<tr valign="top">
			...
			<tr valign="top">
				...
				<td>
					<input type="text" name="geot[city]" id="geot_city"
					       data-placeholder="<?php _e( 'Type cities separated by comma', 'geot' ); ?>"/>
				</td>
				<td colspan="2"></td>
			</tr>
			<tr valign="top">
