	...
	<form name="geot-settings" method="post" enctype="multipart/form-data">
		<table class="form-table">
			...
			<tr valign="top" class="">
				...
				<td colspan="3">
					<label><input type="checkbox" id="geo-flags" name="geot_addons[geo-flags]" value="1" <?php checked($opts['geo-flags'],'1');?>/>
			...
			<tr valign="top" class="">
				...
				<td colspan="3">
					<label><input type="checkbox" id="geo-links" name="geot_addons[geo-links]" value="1" <?php checked($opts['geo-links'],'1');?>/>
			...
			<tr valign="top" class="">
				...
				<td colspan="3">
					<label><input type="checkbox" id="geo-redirects" name="geot_addons[geo-redirects]" value="1" <?php checked($opts['geo-redirects'],'1');?>/>
			...
			<tr valign="top" class="">
				...
				<td colspan="3">
					<label><input type="checkbox" id="geo-blocker" name="geot_addons[geo-blocker]" value="1" <?php checked($opts['geo-blocker'],'1');?>/>
			...
			<tr><td><input type="submit" name="geot_addons[button]" class="button-primary" value="<?php _e( 'Save settings', 'geot' );?>"/></td>
