...
class Geot_Helper {
	...
	*/
	...
	public static function ajax_render_rules( $options = array() ) {
		...
		switch($options['param']) {
			...
			case "post_type":
				...
				$choices = apply_filters('geot/get_post_types', get_post_types(), array('attachment') );
				break;
			...
			case "page_template" :
				...
				$choices = array( 'default'	=> __("Default Template", 'geot'),	);
			...
			case "search_engine" :
			case "same_site" :
				$choices = array('true' => __( 'True',  'geot' ) );
				break;
		}
	...
	public static function html_rules($post, $meta_key, $args = array() ) {
