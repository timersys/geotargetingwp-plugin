<?php
/**
 * This is Geot Country module
 *
 * @class FLGeotCountry
 */
class FLGeotCountry extends FLBuilderModule {
	...
	public function __construct() {
		parent::__construct(array(
			'name'			=> __('Geot Country', 'geot'),
			'description'	=> __('Geot Country.', 'geot'),
			'category'      => __('Geot Targeting', 'geot'),
			'dir'           => GEOWP_PLUGIN_DIR . 'includes/wpbeaver/modules/wpbeaver-geot-country/',
			'url'           => GEOWP_PLUGIN_URL . 'includes/wpbeaver/modules/wpbeaver-geot-country/',
 ...
 */
FLBuilder::register_module('FLGeotCountry', array(
	'general'       => array( // Tab
		'title'         => __('General', 'geot'), // Tab title
