 ...
 * @return string
 */
function ajax_geot_filter( $args = [], $content = '' ) {
 ...
 * @return string
 */
function ajax_geot_filter_city( $args = [], $content = '' ) {
	extract( wp_parse_args( $args, [
		'city'           => '',
		'region'         => '',
		'exclude_city'   => '',
 ...
 * @return string
 */
function ajax_geot_filter_state( $args = [], $content = '' ) {
	extract( wp_parse_args( $args, [
		'state'         => '',
		'exclude_state' => '',
		'html_tag'      => 'div',
 ...
 * @return string
 */
function ajax_geot_filter_zip( $args = [], $content = '' ) {
	extract( wp_parse_args( $args, [
		'zip'         => '',
		'exclude_zip' => '',
		'html_tag'    => 'div',
