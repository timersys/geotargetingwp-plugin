...
class GeotWP_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$regions       = ! empty( $instance['regions'] ) ? $instance['regions'] : [];
		...
		<div class="geot_dropdown_container">
			<select class="geot_dropdown geot-ddslick" name="geot_dropdown" id="geot_dropdown"
				...
				foreach ( $countries as $c ) {
					...
					?>
					<option value="<?php echo $c->iso_code; ?>" <?php echo $user_country->iso_code == $c->iso_code ? 'selected="selected"' : ''; ?>
	...
	public function form( $instance ) {
		...
		<p>
			...
			<select multiple="multiple" class="widefat" id="<?php echo $this->get_field_id( 'regions' ); ?>"
