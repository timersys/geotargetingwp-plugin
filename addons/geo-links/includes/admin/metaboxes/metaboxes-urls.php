							...
							<tr valign="top">
								...
								<td>
									<select name="geol[dest][<?php echo $key; ?>][countries][]"
									        ...
									        placeholder="<?php _e( 'Choose one or more countries', 'geol' ); ?>"
									        multiple="multiple">
									...
									<p class="help-text"
									   style="margin-top: -20px;"><?php _e( 'Choose one or more countries', 'geol' ); ?></p>
								</td>
							</tr>
							<tr>
								...
								<td>
									<select name="geol[dest][<?php echo $key; ?>][regions][]"
									        ...
									        placeholder="<?php _e( 'Choose one or more regions', 'geol' ); ?>"
									        multiple="multiple">
									...
									<p class="help-text"
									   style="margin-top: -20px;"><?php echo sprintf( __( 'Choose one or more regions. Edit regions in <a href="%s">here</a>', 'geol' ), admin_url( 'admin.php?page=geot-settings' ) ); ?></p>
								</td>
							</tr>
							<tr>
