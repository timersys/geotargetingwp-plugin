...
class Geotr_Rules {
	...
	public static function init() {
		...
		// Geotargeting
		add_filter( 'geotr/rules/rule_match/country', [ self::class, 'rule_match_country' ] );
		add_filter( 'geotr/rules/rule_match/country_region', [ self::class, 'rule_match_country_region' ] );
		add_filter( 'geotr/rules/rule_match/city', [ self::class, 'rule_match_city' ] );
		add_filter( 'geotr/rules/rule_match/city_region', [ self::class, 'rule_match_city_region' ] );
		add_filter( 'geotr/rules/rule_match/state', [ self::class, 'rule_match_state' ] );
		add_filter( 'geotr/rules/rule_match/zip', [ self::class, 'rule_match_zip' ] );

		// User
		add_filter( 'geotr/rules/rule_match/user_type', [ self::class, 'rule_match_user_type' ] );
		add_filter( 'geotr/rules/rule_match/logged_user', [ self::class, 'rule_match_logged_user' ] );
		add_filter( 'geotr/rules/rule_match/left_comment', [ self::class, 'rule_match_left_comment' ] );
		add_filter( 'geotr/rules/rule_match/search_engine', [ self::class, 'rule_match_search_engine' ] );
		add_filter( 'geotr/rules/rule_match/same_site', [ self::class, 'rule_match_same_site' ] );

		// Post
		add_filter( 'geotr/rules/rule_match/post_type', [ self::class, 'rule_match_post_type' ] );
		add_filter( 'geotr/rules/rule_match/post_id', [ self::class, 'rule_match_post' ] );
		add_filter( 'geotr/rules/rule_match/post', [ self::class, 'rule_match_post' ] );
		add_filter( 'geotr/rules/rule_match/post_category', [ self::class, 'rule_match_post_category' ] );
		add_filter( 'geotr/rules/rule_match/post_format', [ self::class, 'rule_match_post_format' ] );
		add_filter( 'geotr/rules/rule_match/post_status', [ self::class, 'rule_match_post_status' ] );
		add_filter( 'geotr/rules/rule_match/taxonomy', [ self::class, 'rule_match_taxonomy' ] );

		// Page
		add_filter( 'geotr/rules/rule_match/page', [ self::class, 'rule_match_post' ] );
		add_filter( 'geotr/rules/rule_match/page_type', [ self::class, 'rule_match_page_type' ] );
		add_filter( 'geotr/rules/rule_match/page_parent', [ self::class, 'rule_match_page_parent' ] );
		add_filter( 'geotr/rules/rule_match/page_template', [ self::class, 'rule_match_page_template' ] );

		//Other
		add_filter( 'geotr/rules/rule_match/custom_url', [ self::class, 'rule_match_custom_url' ] );
		add_filter( 'geotr/rules/rule_match/cookie', [ self::class, 'rule_match_cookie' ] );
		add_filter( 'geotr/rules/rule_match/mobiles', [ self::class, 'rule_match_mobiles' ] );
		add_filter( 'geotr/rules/rule_match/tablets', [ self::class, 'rule_match_tablets' ] );
		add_filter( 'geotr/rules/rule_match/desktop', [ self::class, 'rule_match_desktop' ] );
		add_filter( 'geotr/rules/rule_match/referrer', [ self::class, 'rule_match_referrer' ] );
		add_filter( 'geotr/rules/rule_match/crawlers', [ self::class, 'rule_match_crawlers' ] );
		add_filter( 'geotr/rules/rule_match/query_string', [ self::class, 'rule_match_query_string' ] );
	}
	...
	*/
	...
	public static function set_rules_fields() {
		// GEO
		add_action( 'geotr/rules/print_country_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_country_region_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_city_region_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_city_field', [ 'Geotr_Helper', 'print_textfield' ], 10, 2 );
		add_action( 'geotr/rules/print_state_field', [ 'Geotr_Helper', 'print_textfield' ], 10, 1 );
		add_action( 'geotr/rules/print_zip_field', [ 'Geotr_Helper', 'print_textfield' ], 10, 1 );

		// User
		add_action( 'geotr/rules/print_user_type_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_logged_user_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_left_comment_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_search_engine_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_same_site_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );

		// Post
		add_action( 'geotr/rules/print_post_type_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_post_id_field', [ 'Geotr_Helper', 'print_textfield' ], 10, 1 );
		add_action( 'geotr/rules/print_post_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_post_category_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_post_format_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_post_status_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_taxonomy_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );

		// Page
		add_action( 'geotr/rules/print_page_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_page_type_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_page_parent_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_page_template_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );

		//Other
		add_action( 'geotr/rules/print_custom_url_field', [ 'Geotr_Helper', 'print_textfield' ], 10, 1 );
		add_action( 'geotr/rules/print_mobiles_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_desktop_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_tablets_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_crawlers_field', [ 'Geotr_Helper', 'print_select' ], 10, 2 );
		add_action( 'geotr/rules/print_referrer_field', [ 'Geotr_Helper', 'print_textfield' ], 10, 1 );
		add_action( 'geotr/rules/print_query_string_field', [ 'Geotr_Helper', 'print_textfield' ], 10, 1 );
		add_action( 'geotr/rules/print_cookie_field', [ 'Geotr_Helper', 'print_textfield' ], 10, 1 );
	}
